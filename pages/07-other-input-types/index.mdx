...
<Field name="bestConferences" component="select" multiple>
  <option value="React Europe 2016">React Europe 2016</option>
  <option value="React Europe 2017">React Europe 2017</option>
  <option value="React Europe 2019">React Europe 2018</option>
  <option value="React Europe 2019">React Europe 2019</option>
  <option value="React Europe 2020">React Europe 2020</option>
</Field>
```
